...
static unsigned int l_pageCount = 16;  ///< The number of pages to request per chunk. Set up in
				       ///< liballoc_init.
...
void *_calloc_r(struct _reent *reent, size_t obj, size_t size)
{
	(void)reent;

	return calloc(obj, size);
}
