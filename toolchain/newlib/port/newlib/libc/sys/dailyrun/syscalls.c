...
#define DEFINE_SYSCALL_1_default(_ret_type, _syscall, _nr, _type1, ...)                     \
	...
	{                                                                                   \
		_ret_type ret;                                                              \
		__asm__ volatile("int $0x80" : "=a"(ret) : "a"(_nr), "b"(arg1) : "memory"); \
		if (ret < 0) {                                                              \
			errno = -(int)ret;                                                  \
			ret = (_ret_type) - 1;                                              \
		}                                                                           \
...
#define DEFINE_SYSCALL_3_default(_ret_type, _syscall, _nr, _type1, _type2, _type3, ...)         \
	_ret_type _##_syscall(_type1 arg1, _type2 arg2, _type3 arg3 __VA_OPT__(, ) __VA_ARGS__) \
	{                                                                                       \
		_ret_type ret;                                                                  \
		__asm__ volatile("int $0x80"                                                    \
				 : "=a"(ret)                                                    \
...
#define DEFINE_SYSCALL_4_default(_ret_type, _syscall, _nr, _type1, _type2, _type3, _type4, ...)  \
	_ret_type _##_syscall(_type1 arg1, _type2 arg2, _type3 arg3, _type4 arg4, ##__VA_ARGS__) \
	{                                                                                        \
		_ret_type ret;                                                                   \
		__asm__ volatile("int $0x80"                                                     \
				 : "=a"(ret)                                                     \
...
#define DEFINE_SYSCALL_5_default(_ret_type, _syscall, _nr, _type1, _type2, _type3, _type4, _type5, \
				 ...)                                                              \
	_ret_type _##_syscall(_type1 arg1, _type2 arg2, _type3 arg3, _type4 arg4, _type5 arg5,     \
			      ##__VA_ARGS__)                                                       \
	{                                                                                          \
		_ret_type ret;                                                                     \
		__asm__ volatile("int $0x80"                                                       \
				 : "=a"(ret)                                                       \
				 : "a"(_nr), "b"(arg1), "c"(arg2), "d"(arg3), "S"(arg4), "D"(arg5) \
				 : "memory");                                                      \
		if (ret < 0) {                                                                     \
			errno = -(int)ret;                                                         \
			ret = (_ret_type) - 1;                                                     \
...
#define DEFINE_SYSCALL_6_default(_ret_type, _syscall, _nr, _type1, _type2, _type3, _type4, _type5, \
				 _type6, ...)                                                      \
	_ret_type _##_syscall(_type1 arg1, _type2 arg2, _type3 arg3, _type4 arg4, _type5 arg5,     \
			      _type6 arg6, ##__VA_ARGS__)                                          \
	{                                                                                          \
		_ret_type ret;                                                                     \
                                                                                                   \
 ...
 *
 */
ssize_t sendto(int fd, const void *buffer, size_t length, int flags, const struct sockaddr *addr,
	       socklen_t addr_len)
{
	struct iovec iov = {
 ...
 */
ssize_t
recvfrom(int fd, void *data, size_t len, int flags, struct sockaddr *addr, socklen_t *addrlen)
{
	struct iovec iov = {
	    .iov_base = data,
	    .iov_len = len,
