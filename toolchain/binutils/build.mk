BINUTILS_TOOLCHAIN_DIR := $(TOOLCHAIN_DIR)/binutils
...
BINUTILS_TAR       := $(BINUTILS_TOOLCHAIN_DIR)/binutils-$(BINUTILS_VERSION).tar.gz
BINUTILS_DIR       := $(BINUTILS_TOOLCHAIN_DIR)/binutils-$(BINUTILS_VERSION)
...
$(BINUTILS_DIR): $(BINUTILS_TAR)
	...
	$(call LOG,PATCH,$@)
	$(SILENT)cp -rf $(BINUTILS_TOOLCHAIN_DIR)/target/* $@
