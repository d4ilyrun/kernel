...
#define DECLARE_SYSCALL(name, vector, argc, ...) [SYS_##name] = {#name, (void *)sys_##name, argc},

/** The list of all the available syscalls and their respective handler */
static const struct syscall syscalls[SYSCALL_COUNT] = {DEFINE_SYSCALLS(DECLARE_SYSCALL)};

#define DO_SYSCALL_0(_syscall) (((u32 (*)(void))_syscall)())

#define DO_SYSCALL_1(_syscall, _arg1) (((u32 (*)(void *))_syscall)((void *)_arg1))
...
#define DO_SYSCALL_3(_syscall, _arg1, _arg2, _arg3) \
	(((u32 (*)(void *, void *, void *))_syscall)((void *)_arg1, (void *)_arg2, (void *)_arg3))

#define DO_SYSCALL_4(_syscall, _arg1, _arg2, _arg3, _arg4)                                 \
	(((u32 (*)(void *, void *, void *, void *))_syscall)((void *)_arg1, (void *)_arg2, \
							     (void *)_arg3, (void *)_arg4))

#define DO_SYSCALL_5(_syscall, _arg1, _arg2, _arg3, _arg4, _arg5)     \
	(((u32 (*)(void *, void *, void *, void *, void *))_syscall)( \
	    (void *)_arg1, (void *)_arg2, (void *)_arg3, (void *)_arg4, (void *)_arg5))
...
static interrupt_return_t syscall(void *data)
{
	...
	case 3:
		...
		break;
	case 4:
		ret = DO_SYSCALL_4(syscall->handler, args.arg1, args.arg2, args.arg3, args.arg4);
		break;
	case 5:
		ret = DO_SYSCALL_5(syscall->handler, args.arg1, args.arg2, args.arg3, args.arg4,
				   args.arg5);
		break;
	case 6:
		ret = DO_SYSCALL_6(syscall->handler, args.arg1, args.arg2, args.arg3, args.arg4,
				   args.arg5, args.arg6);
		break;
	default:
		log_err("%s: unsupported arg count (%d)", syscall->name, syscall->arg_count);
		ret = -E_NOT_SUPPORTED;
		goto syscall_exit;
	}
