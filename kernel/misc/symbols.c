...
static ALWAYS_INLINE const kernel_symbol_t *kernel_symbol_next(const kernel_symbol_t *symbol)
{
...
{
	const kernel_symbol_t *symbol = (const kernel_symbol_t *)kernel_symbols.symbols;
