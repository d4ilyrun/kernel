 ...
 *
 */
static error_t af_unix_bind(struct socket *socket, const struct sockaddr *addr, socklen_t addr_len)
{
 ...
 */
static error_t
af_unix_connect(struct socket *socket, const struct sockaddr *addr, socklen_t addr_len)
{
	struct sockaddr_un *sun = (struct sockaddr_un *)addr;
 ...
 *
 */
static ssize_t af_unix_send_one(struct socket *socket, const struct iovec *iov, int flags)
{
	struct usock *usock = socket->data;
 ...
 *
 */
static ssize_t af_unix_sendmsg(struct socket *socket, const struct msghdr *msg, int flags)
{
	if (msg->msg_name) {
 ...
 *
 */
static error_t af_unix_verify_addr(const struct sockaddr *addr, socklen_t addr_len)
{
	struct sockaddr_un *sun = (struct sockaddr_un *)addr;
