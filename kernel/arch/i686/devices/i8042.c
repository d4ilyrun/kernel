...
#define STATUS_COMMAND                                                     \
	BIT(3)			   /* indicate whether data written is for \
...
static error_t i8042_init_keyboard(void)
{
	...
	interrupts_install_threaded_handler(PIC_MASTER_VECTOR + IRQ_KEYBOARD,
					    ...
					    i8042_keyboard_threaded_interrupt, kb);
...
static error_t i8042_init_mouse(void)
{
	...
	interrupts_install_threaded_handler(PIC_MASTER_VECTOR + IRQ_PS2, i8042_mouse_interrupt,
					    i8042_mouse_threaded_interrupt, mouse);
