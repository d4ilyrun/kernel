...
void tree_add_child_sorted(tree_node_t *node, tree_node_t *child, compare_t compare)
{
...
tree_node_t *tree_find_child(tree_node_t *node, compare_t compare, const void *data)
{
