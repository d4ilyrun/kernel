...
/** Dummy constructor for @ref kmem_cache_create().
 *
 * This can be used when the object type does not need to be constructed.
 */
static inline void kmem_cache_empty_constructor(void *data)
{
    UNUSED(data);
}

/** Dummy destructor for @ref kmem_cache_create().
 *
 * This can be used when the object type does not need to be destructed.
 */
static inline void kmem_cache_empty_destructor(void *data)
{
    UNUSED(data);
}
