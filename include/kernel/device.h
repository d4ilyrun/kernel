 ...
 * @info \c _off_type must be indirectly castable into an integer
 */
#define generate_device_io_rw_functions(_pfx, _dev_type, _reg_field, _off_type) \
...
#define __device_io_read(_type, _type_pfx, _pfx, _device_type, _device_reg_field, _off_type) \
	static MAYBE_UNUSED inline _type _pfx##_in##_type_pfx(_device_type *device,          \
							      _off_type offset)              \
	{                                                                                    \
		return in##_type_pfx(device->_device_reg_field + offset);                    \
	}

#define __device_io_write(_type, _type_pfx, _pfx, _device_type, _device_reg_field, _off_type) \
	static MAYBE_UNUSED inline void _pfx##_out##_type_pfx(_device_type *device,           \
							      _off_type offset, _type val)    \
	{                                                                                     \
