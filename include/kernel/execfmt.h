...
struct execfmt {
    ...
    error_t (*load)(struct executable *, void *); ///< Load an executable file
                                                  ///< in memory
    error_t (*execute)(struct executable *);      ///< Run a loaded executable
    void (*unload)(struct executable *); ///< Unload an executable. Called
                                         ///< after the file execution has
                                         ///< been completed.
};
